...
<div class="flex h-full min-h-0 overflow-hidden">
	<div class="flex h-full min-h-0 w-full justify-between gap-15">
		<section
			class="flex h-full min-h-0 w-[30%] min-w-80 flex-col gap-5 overflow-y-auto p-2 text-center [&>*]:shrink-0"
		>
		...
		<section
			class="flex min-h-0 w-[70%] max-w-screen items-center justify-center overflow-hidden p-2"
		>
			{#if loading}
